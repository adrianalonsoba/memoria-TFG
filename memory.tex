...
\item \textbf{depth}: Sets the depth of the charts.
\end{itemize}
...
Once the process is understood, we will focus on this particular chart type, the bars chart. It is suitable for discrete values, here we have a use example where we render a bars chart with the number of commits per month from some software development.
\begin{lstlisting}[frame=single]
