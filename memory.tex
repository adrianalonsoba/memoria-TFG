...
The creation process of the grids is similar to the chart creation process, using THREE.LineBasicMaterial and THREE.Line, we create single lines which are saved in a new data structure (like the chart parts ) and then are placed properly if we call the method gridsOn() at the creation time.
