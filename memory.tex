...
The code follow an object-oriented programming approximation, as we can see in \ref{fig:Architecture}, we have a global object that contain the data structures and methods, \textbf{THREEDC}
 ...
 \item \textbf{baseMixin(chart)}: This method is a mixin with the common properties and methods of all charts, and it will be explained in the next subsection\ref{sec:tm}.
 \end{itemize}
...
and the mixin, which will be described in the next subsection.

\subsection{The mixin}
\label{sec:tm}
aqui explico las funciones del mixin
