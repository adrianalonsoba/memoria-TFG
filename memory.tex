...
The code follow an object-oriented programming approximation, as we can see in \ref{fig:Architecture}, we have a global class that contain the data structures and methods, \textbf{THREEDC}
