...
Here we have a code example which creates the previous iteration demo using the framework:
\begin{lstlisting}[frame=single]
//crossfilter index,dimensions and groups previously created
...
//we pass coordinates for place the chart for now
