...
Following the next Stemkoski demos, we can learn how to add shadows, create our own shapes, add textures to the meshes and much more. 

\subsection{First demo}
primera demo con los charts perpendiculares por ejemplo, con captura y explicacion de código
