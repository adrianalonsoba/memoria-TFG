...
In this sprint, we must to integrate crossfilter\ref{sec:cf} in order to achieve a functionality that allow us to filter data sets in real time by interacting with the charts. There is already a library that do this
