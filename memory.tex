...
The first thing we need is a global object that will contain the data structures, functions and give name to the framework, this object is \textbf{THREEDC}
