...
The mixin will act like a father class, containing the common features in all charts, like render methods, labels, grids, etc... This also makes an easier abstraction. 
TODO LO QUE TENEMOS QUE HACER ES ISNTANCIARLO Y AÑADIRLE METODOS
