...
\subsection{In this project}
As we will see in its corresponding section, we can filter the dimensions of our data sets, leading to re-render or rebuild the charts related to this dimension, so, in order to improve the performance, we need to handle the data sets as fast as we can, and Crossfilter allow us to do it extremely quickly.
