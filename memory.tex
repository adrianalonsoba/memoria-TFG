...
Now that we have all the tools to handle events let's go to add 3D text label to each mesh showing the number of commits or authors. To do this, we can use 'THREE.TextGeometry', a function that makes simple to add 3D text to the scenes just by passing the text, the font family, the size and other optional parameters. 
