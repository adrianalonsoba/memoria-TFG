...
The code follow an object-oriented programming approximation, as we can see in \ref{fig:Architecture}, we have a global object that contain the data structures and methods, \textbf{THREEDC}
...
\begin{itemize}
\item \textbf{parts}: Array with all instantiated charts.
\item \textbf{xLabels}: Array with all instantiated panels.
\item \textbf{yLabels}: The single 3D text showed with info of a chart part.
\item \textbf{xGrids}: Current chart to be dragged.
\item \textbf{yGrids}: Filter value or values to be applied
\item \textbf{\_gridsOn}: Filter value or values to be applied
\item \textbf{\_numberOfXLabels}: Filter value or values to be applied
\item \textbf{\_numberOfYLabels}: Filter value or values to be applied
\item \textbf{\_width}: Filter value or values to be applied
\item \textbf{\_height}: Filter value or values to be applied
\end{itemize}
...
\begin{enumerate}
  \item Mejora de dragging con grupos
  \item mejora grafica y optimización
  \item mas tipos de graficos
  \item añadir animaciones
  \item integracion con elastic search y kibana
\end{enumerate}
