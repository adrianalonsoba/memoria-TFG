...
\begin{enumerate}
\item Achieve an interface and functionality as similar as the Dc.js as possible.
\item Use any webGL renderer, in order to render the dashboard inside the web browser.
