...
\item \textbf{numberOfCharts}: The number of charts that the panel will contain. With this number, 
anchor points shall be calculated in function of the panel size, and then, the charts will be placed on them.
